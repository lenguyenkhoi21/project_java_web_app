<%-- 
    Document   : homeSearchProduct
    Created on : Jul 19, 2020, 6:02:32 PM
    Author     : Milu
--%>
                    ...
                    <div class="col-sm-9">
                        ...
                        <div class="mainmenu pull-left">
                            <ul class="nav navbar-nav collapse navbar-collapse">
                                ...
                                <li><a href="home_product">Cửa hàng</a></li>
                ...
                <div class="col-sm-9 padding-right">
                    <div class="features_items">
                        ...
                        <%
                            ...
                            ArrayList<SanPham> dsSanPhamHot = spDAO.searchSanPham(keyword);
