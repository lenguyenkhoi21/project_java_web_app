<%-- 
    Document   : adminAddNewProduct
    Created on : Jul 17, 2020, 10:03:29 PM
    Author     : Milu
--%>
        ...
        <div class="page-content--bgf7">
            ...
            <section class="welcome p-t-10">
                <div class="container">
                    <div class="row">
                        <div class="col-md-12">
                            <h1 class="title-4"> Thêm sản phẩm mới
                            </h1>
                                        ...
                                        <div class="row form-group">
                                            ...
                                            <div class="col-11">
                                                <div class="form-group">
                                                    ...
                                                    <%  SanPhamDAO spdao = new SanPhamDAO();
                                                        String newID = spdao.getLastId();
                                                    %>
                                                    <input type="text" id="company" class="form-control" readonly name="id" value="<%=newID%>">
                                                 </div>
                                            </div>
                                            <div class="col-11">
                                                <div class="form-group">
                                                    <label for="city" class=" form-control-label">Tên</label>
                                                    <input type="text" id="city" placeholder="Tên sản phẩm" class="form-control" name="ten">
                                                </div>
                                            </div>
                                            <div class="col-11">
                                                <div class="form-group">
                                                    <label for="city" class=" form-control-label">Loại</label>
                                                    <input type="text" id="city" placeholder="Loại sản phẩm" class="form-control" name="loai">
                                                </div>
                                            </div>
                                            <div class="col-11">
                                                <div class="form-group">
                                                    <label for="city" class=" form-control-label">Giá</label>
                                                    <input type="text" id="city" placeholder="Giá sản phẩm" class="form-control" name="gia">
                                                </div>
                                            </div>
                                            <div class="col-11">
                                                <div class="form-group">
                                                    <label for="city" class=" form-control-label">Tổng số lượng</label>
                                                    <input type="text" id="city" placeholder="Số lượng trong kho" class="form-control" name="tongSL">
                                                </div>
                                            </div>
                                            <div class="col-11">
                                                <div class="form-group">
                                                    <label for="city" class=" form-control-label">Trạng thái</label>
                                                    <input type="text" id="city" placeholder="Còn hàng, hết hàng, hàng mới,..." class="form-control" name="trangthai">
                                                </div>
                                            </div>
                                            <div class="col-11">
                                                <div class="form-group">
                                            ...
                                            <div class="col-11">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" id="city" placeholder="Link trên máy chủ" class="form-control" name="url">
                                                </div>
                                            </div>
