<%-- 
    ...
    Created on : Jul 19, 2020, 7:09:15 PM
    Author     : Milu
--%>
        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-lg-6">
                    ...
                    %>
                    <form action="actionUpdateProfile">
                    <div class="form-group"> 
                        <label> Tài khoản </label>
                        <input type="text" class="form-control" value="<%= uDB.getTenDangNhap() %>" readonly name="username">
                    </div>
                    <div class="form-group"> 
                        <label> Mật khẩu </label>
                        <input type="password" class="form-control" value="<%= uDB.getMatKhau() %>" name="password">
                    </div>
                    <div class="form-group"> 
                        <label> Email </label>
                        <input type="email" class="form-control" value="<%= uDB.getEmail() %>" name="email">
                    </div>
                    <div class="form-group"> 
                        <label> Số điện thoại </label>
                        <input type="text" class="form-control" value="<%= uDB.getPhone() %>" name="phone">
                    </div>
                    <div class="form-group"> 
                        <label> Địa chỉ </label>
                        <input type="text" class="form-control" value="<%= uDB.getDiaChi() %>" name="address">
                    </div>
                    <div class="form-group"> 
                        <label> Tên khách hàng </label>
                        <input type="text" class="form-control" value="<%= uDB.getTenKhachHang() %>" name="name">
                    </div>
                    <button class="btn btn-default update" type="submit"> Cập Nhật </button>>
                    <a class="btn btn-default update"> Hủy </a>
                    </form>
                </div>
