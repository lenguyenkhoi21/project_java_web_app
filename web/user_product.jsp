<%-- 
    ...
    Created on : Jul 13, 2020, 8:46:04 AM
    Author     : Milu
--%>
                                ...
                                <div class="single-products">
                                    ...
                                    <div class="product-overlay">
                                        <div class="overlay-content">
                                            <p><a style="color: white;" href="user_product_details?id=<%=sp.getMaSanPham()%>&ten=<%=sp.getSanPhamName()%>&theloai=<%=sp.getLoaiSanPham()%>&url=<%= sp.getUrl() %>&gia=<%= sp.getGiaNiemYet() %>&tinhtrang=<%= sp.getTrangThai() %>"> <%= sp.getSanPhamName() %> </a></p>
