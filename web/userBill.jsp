<%-- 
    Document   : userBill
    Created on : Jul 19, 2020, 10:14:16 PM
    Author     : Milu
--%>
            ...
            <div class="row">
                ...
                <div class="col-lg-6">
                    <%
                        ...
                        List dsHD = hdDAO.getDSHoaDon(user.getTenDangNhap());
                        if (dsHD.isEmpty()) {
                    %>
                ...
                <table class="table table-condensed">
                    <thead>
                        <tr class="cart_menu">
                            <td class="image"><h4>Mã hóa đơn</h4></td>
                            <td class="price"><h4>Ngày tạo</h4></td>
                            <td class="quantity"><h4>Xem chi tiết</h4></td>
                            <td></td>
                        </tr>
                    </thead>
                    <tbody>
                        <%
                            for (Iterator it = dsHD.iterator(); it.hasNext();) {
                                    HoaDon elem = (HoaDon) it.next();
                        ...
                        <tr>
                            ...
                            <td class="cart_description">
                                <h4><%= elem.getMaHoaDon() %></h4>
                            </td>
                            
                            <td class="cart_price">
                                <h4><%= elem.getNgayTao() %></h4>
                            </td>
                            
                            <td class="cart_quantity">
                                <h4> <a href="userBillDetails?id=<%= elem.getMaHoaDon() %>"> Bấm vô </a> </h4>
                            </td>
