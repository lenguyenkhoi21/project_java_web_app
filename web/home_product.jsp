<%-- 
    Document   : home_product
    Created on : Jul 13, 2020, 8:43:24 AM
    Author     : Milu
--%>
                    ...
                    <div class="col-sm-9">
                        ...
                        <div class="mainmenu pull-left">
                            <ul class="nav navbar-nav collapse navbar-collapse">
                                ...
                                <li><a href="home_product" class="active">Cửa hàng</a></li>
            ...
            <div class="row">
                ...
                <div class="col-sm-9 padding-right">
                    ...
                    <div class="features_items">
                        <!--features_items-->
                        <h2 class="title text-center">Sản phảm hot</h2>
                        <%
                            List dsSanPhamHot = spDAO.getSanPhamByTheLoai(request.getParameter("theloai"));
                            for (Iterator it = dsSanPhamHot.iterator(); it.hasNext();) {
                                    Object elem = it.next();
                                    SanPham sp = (SanPham) elem;
                            ...
                            <div class="product-image-wrapper">
                                <div class="single-products">
                                    <div class="productinfo text-center">
                                        <img src="<%= sp.getUrl() %>" alt="" />
                                        <h2><%= sp.getGiaNiemYet() %></h2>
                                        <p> <%= sp.getSanPhamName() %> </p>
                                        
                                      
                                    </div>
                                    <div class="product-overlay">
                                        <div class="overlay-content">
                                            <p><a style="color: white;" href="home_product_details?id=<%=sp.getMaSanPham()%>&ten=<%=sp.getSanPhamName()%>&theloai=<%=sp.getLoaiSanPham()%>&url=<%= sp.getUrl() %>&gia=<%= sp.getGiaNiemYet() %>&tinhtrang=<%= sp.getTrangThai() %>"> <%= sp.getSanPhamName() %> </a></p>
                                            
                                            
                                        </div>
                                    </div>
                        <%
                            if (sp.getTrangThai().equals("Hàng mới")) {
                                
                            
                        %>
                            <image src="images/home/new.png" class="new" alt="" />
                        <%
                            }
                        %>
                                </div>
